...
export const penalizerReportStatus = async (report_type: string | null, reportId: number, data: PenalizeReportStatusData) => {
    try {
...
export const dismissReportStatus = async (report_type: string | null, reportId: number, data: DismissReportStatusData) => {
    try {
