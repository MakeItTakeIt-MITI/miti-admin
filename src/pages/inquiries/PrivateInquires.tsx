            ...
            <table className={`min-w-[900px] ${TABLE_STYLES.table}`}>
              <thead className={TABLE_STYLES.head}>
                <tr className={TABLE_STYLES.headerRow}>
                  ...
                  <th className={`${TABLE_STYLES.headerCell} w-44`}>닉네임</th>
              ...
              <tbody>
                {!rows || rows.length === 0 ? (
                  <tr>
                    <td className={TABLE_STYLES.emptyCell} colSpan={7}>
                      결과가 없습니다.
                    </td>
                  </tr>
                ) : (
                  rows.map((i) => {
                    ...
                    return (
                      <tr key={i.id} className={TABLE_STYLES.bodyRow}>
                        ...
                        <td className={`${TABLE_STYLES.bodyCell} text-zinc-300`}>
                          {i.nickname || "—"}
                        </td>
                        <td
